...
//基本设置--------------------------------------------------------------------------------------------
$_ENV['key'] = 'mPc9RHyxSYv2k4Gf';            //!!! 瞎 jb 修改此key为随机字符串确保网站安全!!!
$_ENV['debug'] =  false;                //正式环境请确保为 false
$_ENV['appName'] = 'sspanel';             //站点名称
$_ENV['baseUrl'] = 'https://sp.xxnet.ml';          //站点地址
...
$_ENV['reg_method'] = 'chacha20-ietf-poly1305';            //注册时默认加密方式
$_ENV['reg_protocol'] = '';         //注册时默认协议
$_ENV['reg_protocol_param'] = '';         //注册时默认协议参数
$_ENV['reg_obfs'] = 'http_simple';              //注册时默认混淆方式
$_ENV['reg_obfs_param'] = 'obfs-host=www.baidu.com';     //注册时默认混淆参数 设置单端口后 这边必须配置！填写www.jd.hk就行
